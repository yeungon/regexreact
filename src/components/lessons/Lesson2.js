...
export default class Lesson2 extends Component {
  ...
  handleMatchDataCheck() {
    const a = this.handleMatchDataAll(
      this.state.matchData1,
      "1",
      this.state.taskIncompleted
    );

    const b = this.handleMatchDataAll(
      this.state.matchData2,
      "2",
      this.state.taskIncompleted
    );

    const c = this.handleMatchDataAll(
      this.state.matchData3,
      "3",
      this.state.taskIncompleted
    );
      ...
      <div>
        <div>
          ...
          <div className="lesson">
            <div className="title">Lesson 1½: The 123s</div>
            <div className="body">
              <p>
                Characters include normal letters, but digits as well. In fact,
                numbers 0-9 are also just characters and if you look at an{" "}
                <a
              ...
              <p>
                Over the various lessons, you will be introduced to a number of
                special metacharacters used in regular expressions that can be
                used to match a specific type of character. In this case, the
                character <em>\d</em> can be used in place of{" "}
                <em>any digit from 0 to 9</em>. The preceding slash
                distinguishes it from the simple <em>d</em> character and
                indicates that it is a metacharacter.
              </p>
              <p>
                Below are a few more lines of text containing digits. Try
                writing a pattern that matches all the digits in the strings
                below, and notice how your pattern matches{" "}
                <em>anywhere within the string</em>, not just starting at the
                first character. We will learn how to control this in a later
                lesson.
              </p>
            </div>
          </div>
          ...
          <div className="exercise">
            <div className="title">Exercise 1½: Matching digits</div>
            <table className="tasks_table">
              <tbody>
                ...
                <tr className="problem">
                  ...
                  <td className="text">
                    {Parser(this.state.matchDataDisplay1)}
                  </td>
                  <td className="result succeeded">
                    <img
                      src={this.state.taskImageShow1}
                      alt="To be completed"
                    />
                  </td>
                </tr>
                <tr className="problem">
                  <td className="task">match</td>
                  <td className="text">
                    {Parser(this.state.matchDataDisplay2)}
                  </td>
                  <td className="result succeeded">
                    <img
                      src={this.state.taskImageShow2}
                      alt="To be completed"
                    />
                  </td>
                </tr>
                <tr className="problem">
                  <td className="task">match</td>
                  <td className="text">
                    {Parser(this.state.matchDataDisplay3)}
                  </td>
                  <td className="result succeeded">
                    <img
                      src={this.state.taskImageShow3}
                      alt="To be completed"
                    />
                  </td>
                </tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <p>
                          ...
                          from all the lines to see them match.
                        </p>
                      </td>
                    </tr>
                  </tbody>
            ...
            <div className="solution_hint">
              Solve the above task to continue on to the next problem, or read
              the{" "}
              <a
        ...
        <div className="footer col-xs-12 col-sm-12 col-md-6">
          Next –{" "}
          <Link
            to="/lesson/wildcards_dot"
            title="Lesson 1: An Introduction, and the ABCs"
          >
            Lesson 2: The Dot
          </Link>
          <br />
                    ...
                    <div className="lesson">
                        ...
                        <div className="body">
                            <p>Characters include normal letters, but digits as well. In fact, numbers 0-9 are also just
                                characters and if you look at an <a
                                    href="http://en.wikipedia.org/wiki/ASCII#ASCII_printable_characters"
                                    title="ascii table">ASCII table</a>,
                                they are listed sequentially.</p>
                            <p>Over the various lessons, you will be introduced to a number of special metacharacters
                                used in
                                regular expressions that can be used to match a specific type of character. In this
                                case, the
                                character <em>\d</em> can be used in place of <em>any digit from 0 to 9</em>. The
                                preceding slash
                                distinguishes it from the simple <em>d</em> character and indicates that it is a
                                metacharacter.</p>
                            <p>Below are a few more lines of text containing digits. Try writing a pattern that matches
                                all the digits in the strings below, and notice how your pattern matches <em>anywhere
                                    within the
                                    string</em>, not just starting at the first character. We will learn how to control
                                this in a later
                                lesson.</p>
                        </div>
                    </div>
                    ...
                    <div className="exercise">
                        ...
                        <table className="tasks_table">
                            ...
                            <tr className="problem">
                                ...
                                <td className="result succeeded"><img src={this.state.taskImageShow1}
                                                                      alt='To be completed'/></td>
                            </tr>
                            <tr className="problem">
                                <td className="task">match</td>
                                <td className='text'>{Parser(this.state.matchDataDisplay2)}</td>
                                <td className="result succeeded"><img src={this.state.taskImageShow2}
                                                                      alt='To be completed'/></td>
                            </tr>
                            <tr className="problem">
                                <td className="task">match</td>
                                <td className='text'>{Parser(this.state.matchDataDisplay3)}</td>
                                <td className="result succeeded"><img src={this.state.taskImageShow3}
                                                                      alt='To be completed'/></td>
                            </tr>
                            </tbody>
                        </table>
                        ...
                        <div className="row" style={{margin: 0}}>
                            <div className='solution col-xs-12'
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td className="title">Solution</td>
                                        <td><p>Try typing the common numbers <a onClick={this.handleAddSolution}
                                                                                className="editor_val"
                                                                                href="#">123</a> from all the lines to
                                            see
                                            them match.</p></td>
                                    </tr>
                                    </tbody>
                        ...
                        <div className="solution_hint">
                            Solve the above task to continue on to the next problem, or read the <a
                            onClick={this.handleShowSolution} className="show_solution_button" href="#">Solution</a>.
                        </div>
                    </div>
                </div>
